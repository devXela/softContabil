...
<div class="setores index large-10 medium-9 columns">
    <table cellpadding="0" cellspacing="0">
    <thead>
        <tr>
            <th><?= $this->Paginator->sort('id') ?></th>
            <th><?= $this->Paginator->sort('gerencia_id') ?></th>
    ...
    <?php foreach ($setores as $setor): ?>
        <tr>
            ...
            <td>
                <?= $setor->has('gerencia') ? $this->Html->link($setor->gerencia->id, ['controller' => 'Gerencias', 'action' => 'view', $setor->gerencia->id]) : '' ?>
            </td>
            <td><?= h($setor->setor) ?></td>
            <td class="actions">
